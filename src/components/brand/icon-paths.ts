// GENERATED by apps/web/tools/generate-tokens.ts from docs/design/components/core/Icon.jsx.
// Do not edit. Regenerate: pnpm --filter web tokens. CI: tokens:check.
//
// Every drawing in the SAHRA icon set, as the markup strings the design package
// stores them in. icon.tsx parses these into real SVG children at module load.
